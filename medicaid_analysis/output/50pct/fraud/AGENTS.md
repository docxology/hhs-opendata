# AGENTS.md — `hhs-opendata/medicaid_analysis/output/50pct/fraud`
...
Fraud-detection outputs (sections S33-S40) from the 50% sample run — same regenerable provenance as the parent `50pct/` folder.
...
- Generated by fraud sections S33-S40 (`fraud/` modules) during the 50% run.
