# AGENTS.md — `hhs-opendata/medicaid_analysis/output/1pct/fraud`
...
Fraud-detection outputs (sections S33-S40) from the 1% sample run — same regenerable provenance as the parent `1pct/` folder.
...
- Generated by fraud sections S33-S40 (`fraud/` modules) during the 1% run.
